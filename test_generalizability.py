...
if __name__ == '__main__':
    ...
    config_parser.add_argument('--model_choice', default="stargan", type=str, help='Model Choice(stargan or attentiongan)')
    config_parser.add_argument('--StarG_path', default="./checkpoints/stargan/200000-G.ckpt", type=str, help='Stargan Weight Path')
    config_parser.add_argument('--AttentionG_path', default="./checkpoints/attentiongan/200000-G.ckpt", type=str, help='AttentionGAN Weight Path')
    ...
    for idx, (img_a, c_org) in enumerate(tqdm(test_dataloader, desc='')):
        with torch.no_grad():
            ...
            c_trg_list = GAN.create_labels(c_org)
